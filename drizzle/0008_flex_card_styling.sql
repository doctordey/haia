...
ALTER TABLE "flex_cards" ADD COLUMN IF NOT EXISTS "branding_color" text DEFAULT '#5A5C66' NOT NULL;--> statement-breakpoint
ALTER TABLE "flex_cards" ADD COLUMN IF NOT EXISTS "layout" text DEFAULT 'default' NOT NULL;--> statement-breakpoint
ALTER TABLE "flex_cards" ADD COLUMN IF NOT EXISTS "cta_top_line" text;--> statement-breakpoint
ALTER TABLE "flex_cards" ADD COLUMN IF NOT EXISTS "cta_bottom_line" text;
