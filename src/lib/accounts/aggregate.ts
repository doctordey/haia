 ...
 * changing rows.
 *
 * The `isExcluded` flags on trades and balance ops are TRANSMISSION filters
 * only — they stop items from being sent via the public API and are
 * deliberately NOT consulted here. Hiding a deposit or a trade never changes
 * the balance or statistics; the accounting always reflects what actually
 * happened.
 *
