...
function buildSignalConfig(row: typeof signalConfigs.$inferSelect): SignalConfig {
  return {
    ...
    nqBaseRiskPercent: row.nqBaseRiskPercent,
    nqMaxRiskPercent: row.nqMaxRiskPercent,
    esBaseRiskPercent: row.esBaseRiskPercent,
    esMaxRiskPercent: row.esMaxRiskPercent,
