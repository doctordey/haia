...
ALTER TABLE "flex_cards" ADD COLUMN IF NOT EXISTS "hero_box_text_color" text DEFAULT '#0B0C10' NOT NULL;--> statement-breakpoint
ALTER TABLE "flex_cards" ADD COLUMN IF NOT EXISTS "brand_text" text;
